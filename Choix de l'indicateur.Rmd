  ...
  #In any situation (if Json file is/is not empty)
    ...
    data_new <- data_new %>%
      mutate(filename = json_file$filename,    #get filename
             number_of_predictions = nb_pred)  #get number of predictions
...
#renard4313 Video 1 06_07_2022 11_34_21 1 Part 1/2
...
data_06_07_2022 : On a 530 frames avec une confiance < 34% sur 21486, soit 2,47%.
data_04_07_2022 : on a ?? frames avec une confiance < 34% sur 29415, soit ??%.
