...
frequency_position_04_to_06_07_2022 <- frequency_position(data = data_8h_21h_04_to_06_07_2022, interval_seconds = 600)
```
...
### 2.1.3 Chronologic series without 21h-8h gap

```{r}
  # To get 1 dataset per posture

# Count amount of each posture
frequency_position_04_to_06_07_2022 <- frequency_position(data = data_8h_21h_04_to_06_07_2022, interval_seconds = 600) #/!\ there are still data btw 21h-8h !
...
```{r}
plot(x=frequency_position_8h_21h_04_to_06_07_2022_LYING$compressed_time,frequency_position_8h_21h_04_to_06_07_2022_LYING$lying, type = "l")
