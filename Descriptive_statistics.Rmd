...
# D. Piechart postures calibration phase

Piechart of postures post-infection but without symptoms (= data from 09/07 to
14/07) compared to the symptomatic phase when moving a lot (05/08) & biting
himself while lying all day long (06/08).
