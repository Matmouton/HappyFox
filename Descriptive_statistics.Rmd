...
#Data
load("data_04_to_14_07_2022.Rdata") #load all data between 04 & 14 of July
#rm(list = setdiff(ls(), c("data_04_to_14_07_2022"))) #remove useless data
```
...
# New dataset with the number of predictions as a factor variable
data_group_number_pred <- data_8h_21h_04_to_14_07_2022 %>%
  mutate(group = as.factor(number_of_predictions))

# New dataset with a variable "group" always being "All"
data_group_overall <- data_8h_21h_04_to_14_07_2022 %>%
  mutate(group = "Total")
...
# When 1 prediction
hist((data_8h_21h_04_to_14_07_2022 %>% 
...
data_less_5pred <- data_8h_21h_04_to_14_07_2022 %>% 
...
group1 <- (data_8h_21h_04_to_14_07_2022 %>% #2 pred
  filter(number_of_predictions == 2) %>% 
  select(confidence_gap))[[1]]

group2 <- (data_8h_21h_04_to_14_07_2022 %>% #3 pred
...
frequency_position_04_to_14_07_2022 <- frequency_position(data = data_8h_21h_04_to_14_07_2022, interval_seconds = 3600)


frequency_position_04_to_14_07_2022_PIVOT <- frequency_position_04_to_14_07_2022[,-2] %>% #drop the end_time column
  pivot_longer(
    cols = !start_time, 
    names_to = "Posture", 
    values_to = "Count"
...
frequency_position_04_to_14_07_2022_PIVOT <- pivot_data(data = frequency_position_04_to_14_07_2022,
 ...
 # Test
frequency_position_8h_21h_04_to_14_07_2022_PIVOT <- filter_8h_21h(frequency_position_04_to_14_07_2022_PIVOT, start_time)

rm(frequency_position_04_to_14_07_2022_PIVOT)  #remove data with the 21h-8h gap


# Test

frequency_position_8h_21h_04_to_14_07_2022_PIVOT_compressed_time <- add_compressed_time_variable_PIVOT_data(frequency_position_8h_21h_04_to_14_07_2022_PIVOT)



#remove useless data : no compressed time
rm(frequency_position_8h_21h_04_to_14_07_2022_PIVOT)
```
...
```{r}
#Load data
reliable_data_8h_21h_04_to_14_07_2022 <- data_8h_21h_04_to_14_07_2022 %>% 
...
reliable_frequency_position_04_to_14_07_2022 <- frequency_position(data = reliable_data_8h_21h_04_to_14_07_2022, interval_seconds = 900)

#Pivot data
reliable_frequency_position_04_to_14_07_2022_PIVOT <- reliable_frequency_position_04_to_14_07_2022[,-2] %>% #drop the end_time column
  pivot_longer(
    cols = !start_time, 
    names_to = "Posture", 
    values_to = "Count"
...
reliable_frequency_position_8h_21h_04_to_14_07_2022_PIVOT <- filter_8h_21h(reliable_frequency_position_04_to_14_07_2022_PIVOT, start_time)

rm(reliable_frequency_position_04_to_14_07_2022_PIVOT)  #remove data with the 21h-8h gap

#Add compressed time variable
reliable_frequency_position_8h_21h_04_to_14_07_2022_PIVOT_compressed_time <- add_compressed_time_variable_PIVOT_data(reliable_frequency_position_8h_21h_04_to_14_07_2022_PIVOT)

#remove useless data : no compressed time
rm(reliable_frequency_position_8h_21h_04_to_14_07_2022_PIVOT)
...
plot1 <- ggplot(frequency_position_8h_21h_04_to_14_07_2022_PIVOT_compressed_time, aes(x = Posture, y = Count, fill = Posture)) +
  geom_boxplot() +
  xlab("Posture") +
...
plot2 <- ggplot(reliable_frequency_position_8h_21h_04_to_14_07_2022_PIVOT_compressed_time, aes(x = Posture, y = Count, fill = Posture)) +
  geom_boxplot() +
  xlab("Posture") +
  ylab("Nombre d'occurences toutes les 15 minutes") +
  theme(legend.position = "right")
...
```{r}
# Chart for count
ggplot(data = reliable_frequency_position_8h_21h_04_to_14_07_2022_PIVOT_compressed_time,
       aes(fill = Posture, y = Count, x = compressed_time)) +         #start_time as x variable
  geom_bar(position = "stack", stat = "identity") +              #stacked bars, no %
  ggtitle("Fox4313's posture every 15min between days 04/07/2022 and 06/07/2022",
...
from_data_to_plot(data_8h_21h = reliable_data_8h_21h_04_to_14_07_2022,
                  interval_seconds = 3600,
                  title = "Posture's score of fox 4313",
...
```{r}
grid.arrange(from_data_to_plot(data_8h_21h = data_8h_21h_04_to_14_07_2022,
                  interval_seconds = 3600), 
             from_data_to_plot(data_8h_21h = reliable_data_8h_21h_04_to_14_07_2022,
                  interval_seconds = 3600),
             ncol=2)
...
amount_changes_data_8h_21h_04_to_14_07_2022 <- amount_posture_changes(data_8h_21h_04_to_14_07_2022, "15 minute")

# Skip parts between 21h and 8h
amount_changes_data_8h_21h_04_to_14_07_2022_compressed_time <- add_compressed_time_variable(amount_changes_data_8h_21h_04_to_14_07_2022)

# Plot
ggplot(amount_changes_data_8h_21h_04_to_14_07_2022_compressed_time,
...
# Changes per 15minutes & per day
amount_changes_data_8h_21h_04_to_14_07_2022_reliable_data <- amount_posture_changes(reliable_data_8h_21h_04_to_14_07_2022, "15 minute")

# Skip parts between 21h and 8h
amount_changes_data_8h_21h_04_to_14_07_2022_compressed_time_reliable_data <- add_compressed_time_variable(amount_changes_data_8h_21h_04_to_14_07_2022_reliable_data)

# Plot
ggplot(amount_changes_data_8h_21h_04_to_14_07_2022_compressed_time_reliable_data,
       aes(x = compressed_time, y = Nb_changes)) +
