...
frequency_position <- function(data,
  ...
  df_counts <- df_counts %>%
    ...
    mutate(across(c(sitting, standing, lying, not_visible),
                  ...
                  ~ if_else(sum(sitting, lying, standing, not_visible)/interval_seconds < (existing_data_percent / 100),
...
ggplot(frequency_position_8h_21h_05_to_14_07_2022_StandingSitting_15min_PIVOT_compressed_time %>% 
  ...
  scale_x_continuous(name = "Time between 8h and 21h each day",
                     breaks = c(0,50, 100, 150, 200, 250, 300, 350, 400, 450, 500)) +
  ylab("Time proportion spent in each posture") +
  ggtitle("Postures of fox fox 4313", subtitle = "From 5 to 14 of July 2022, every 2 hours, max 10% NA data")
