...
# remove inexistant data
  frequency_position_15min_8h_21h_05_07_to_08_08_2022_PIVOT <- frequency_position_15min_8h_21h_05_07_to_08_08_2022_PIVOT %>% 
    filter(start_time < "2022-07-15 00:00:00" | start_time >= "2022-08-03 00:00:00")
...
ggplot(data = frequency_position_15min_8h_21h_05_07_to_08_08_2022_PIVOT_compressed_time %>% 
  ...
  ggtitle("Amount of seconds spent in a posture for Fox 4313", subtitle = "From 05/07 to 08/08, year 2022, every 15 minutes") +   #title
...
```
# Indicator 1.1 : Individual plots

We only want counts in this indicator
...
# Indicator 1.2 : Standing & sitting vs lying & not visible
...
frequency_position_05_07_to_08_08_2022_15min <-
  frequency_position(data = reliable_data_8h_21h_05_07_to_08_08_2022, #data
                     interval_seconds = 900, #15min
                     existing_data_percent = 95)  #max 5% of NA data allowed
...
ggplot(frequency_position_8h_21h_05_07_to_08_08_2022_StandingSitting_15min_PIVOT_compressed_time,
  ...
  # Only sitting_standing indicator (Counts)
...
ggplot(frequency_position_8h_21h_05_07_to_08_08_2022_StandingSitting_15min_PIVOT_compressed_time %>% 
  ...
  ylab("Time proportion spent sitting or standing") +
  xlab("Time between 8h and 21h each day") +
  ggtitle("Postures of fox fox 4313", subtitle = "From 05/07 to 08/08, year 2022, every 15min")
