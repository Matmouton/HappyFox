...
# Plots 
  ...
  # Counts
ggplot(frequency_position_8h_21h_05_to_14_07_2022_StandingSitting_15min_PIVOT_compressed_time,
...
# Compute the frequency of each posture
frequency_position_05_to_14_07_2022_30min <-
  frequency_position(data = reliable_data_8h_21h_05_to_14_07_2022, #data
...
# Sum the standing & sitting occurences
frequency_position_05_to_14_07_2022_StandingSitting_30min <- frequency_position_05_to_14_07_2022_30min %>% 
  mutate(sitting_standing = sum(sitting, standing),
         lying_not_visible = sum(lying, not_visible)) #maybe useless but maybe not

# Pivot the data
frequency_position_05_to_14_07_2022_StandingSitting_30min_PIVOT <- pivot_data(data = frequency_position_05_to_14_07_2022_StandingSitting_30min,
                   variables_to_drop = c(end_time, lying, sitting, standing, not_visible),
                   variables_to_merge = c(sitting_standing, lying_not_visible),
                   str_name_merged_labels = "Aggregated_postures",
                   str_name_merged_values = "Count")
...
# Keep only the 8h-21h part
frequency_position_8h_21h_05_to_14_07_2022_StandingSitting_30min_PIVOT <- filter_8h_21h(frequency_position_05_to_14_07_2022_StandingSitting_30min_PIVOT, start_time)
# Remove useless
rm(frequency_position_05_to_14_07_2022_StandingSitting_30min_PIVOT)  #remove data with the 21h-8h gap

# Add a compressed_time variable
frequency_position_8h_21h_05_to_14_07_2022_StandingSitting_30min_PIVOT_compressed_time <- add_compressed_time_variable_PIVOT_data(frequency_position_8h_21h_05_to_14_07_2022_StandingSitting_30min_PIVOT, nbrep = 2)

# Add a proportion variable
frequency_position_8h_21h_05_to_14_07_2022_StandingSitting_30min_PIVOT_compressed_time<- add_proportion(frequency_position_8h_21h_05_to_14_07_2022_StandingSitting_30min_PIVOT_compressed_time,
                      count_variable = Count,
                      period_duration = 900)  #15 mintues by time period = 900 seconds
...
ggplot(frequency_position_8h_21h_05_to_14_07_2022_StandingSitting_30min_PIVOT_compressed_time %>% 
         filter(Aggregated_postures == "sitting_standing"),
...
# Compute the frequency of each posture
frequency_position_05_to_14_07_2022_1h <-
  frequency_position(data = reliable_data_8h_21h_05_to_14_07_2022, #data
...
# Sum the standing & sitting occurences
frequency_position_05_to_14_07_2022_StandingSitting_1h <- frequency_position_05_to_14_07_2022_1h %>% 
  mutate(sitting_standing = sum(sitting, standing),
         lying_not_visible = sum(lying, not_visible)) #maybe useless but maybe not

# Pivot the data
frequency_position_05_to_14_07_2022_StandingSitting_1h_PIVOT <- pivot_data(data = frequency_position_05_to_14_07_2022_StandingSitting_1h,
                   variables_to_drop = c(end_time, lying, sitting, standing, not_visible),
                   variables_to_merge = c(sitting_standing, lying_not_visible),
                   str_name_merged_labels = "Aggregated_postures",
                   str_name_merged_values = "Count")
...
# Keep only the 8h-21h part
frequency_position_8h_21h_05_to_14_07_2022_StandingSitting_1h_PIVOT <- filter_8h_21h(frequency_position_05_to_14_07_2022_StandingSitting_1h_PIVOT, start_time)
# Remove useless
rm(frequency_position_05_to_14_07_2022_StandingSitting_1h_PIVOT)  #remove data with the 21h-8h gap

# Add a compressed_time variable
frequency_position_8h_21h_05_to_14_07_2022_StandingSitting_1h_PIVOT_compressed_time <- add_compressed_time_variable_PIVOT_data(frequency_position_8h_21h_05_to_14_07_2022_StandingSitting_1h_PIVOT, nbrep = 2)

# Add a proportion variable
frequency_position_8h_21h_05_to_14_07_2022_StandingSitting_1h_PIVOT_compressed_time<- add_proportion(frequency_position_8h_21h_05_to_14_07_2022_StandingSitting_1h_PIVOT_compressed_time,
                      count_variable = Count,
                      period_duration = 900)  #15 mintues by time period = 900 seconds
...
ggplot(frequency_position_8h_21h_05_to_14_07_2022_StandingSitting_1h_PIVOT_compressed_time %>% 
         filter(Aggregated_postures == "sitting_standing"),
...
# Compute the frequency of each posture
frequency_position_05_to_14_07_2022_2h <-
  frequency_position(data = reliable_data_8h_21h_05_to_14_07_2022, #data
...
# Sum the standing & sitting occurences
frequency_position_05_to_14_07_2022_StandingSitting_2h <- frequency_position_05_to_14_07_2022_2h %>% 
  mutate(sitting_standing = sum(sitting, standing),
         lying_not_visible = sum(lying, not_visible)) #maybe useless but maybe not

# Pivot the data
frequency_position_05_to_14_07_2022_StandingSitting_2h_PIVOT <- pivot_data(data = frequency_position_05_to_14_07_2022_StandingSitting_2h,
                   variables_to_drop = c(end_time, lying, sitting, standing, not_visible),
                   variables_to_merge = c(sitting_standing, lying_not_visible),
                   str_name_merged_labels = "Aggregated_postures",
                   str_name_merged_values = "Count")
...
# Keep only the 8h-21h part
frequency_position_8h_21h_05_to_14_07_2022_StandingSitting_2h_PIVOT <- filter_8h_21h(frequency_position_05_to_14_07_2022_StandingSitting_2h_PIVOT, start_time)
# Remove useless
rm(frequency_position_05_to_14_07_2022_StandingSitting_2h_PIVOT)  #remove data with the 21h-8h gap

# Add a compressed_time variable
frequency_position_8h_21h_05_to_14_07_2022_StandingSitting_2h_PIVOT_compressed_time <- add_compressed_time_variable_PIVOT_data(frequency_position_8h_21h_05_to_14_07_2022_StandingSitting_2h_PIVOT, nbrep = 2)

# Add a proportion variable
frequency_position_8h_21h_05_to_14_07_2022_StandingSitting_2h_PIVOT_compressed_time<- add_proportion(frequency_position_8h_21h_05_to_14_07_2022_StandingSitting_2h_PIVOT_compressed_time,
                      count_variable = Count,
                      period_duration = 900)  #15 mintues by time period = 900 seconds
...
ggplot(frequency_position_8h_21h_05_to_14_07_2022_StandingSitting_2h_PIVOT_compressed_time %>% 
         filter(Aggregated_postures == "sitting_standing"),
