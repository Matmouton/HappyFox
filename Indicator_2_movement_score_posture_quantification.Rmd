...
amount_activity_04_to_06_07_2022 <- amount_activity(data = data_8h_21h_04_to_06_07_2022_increasing_code,
...
amount_activity_8h_21h_04_to_06_07_2022 <- filter_8h_21h(
  data = amount_activity_04_to_06_07_2022,
  time_column = interval_start)

rm(amount_activity_04_to_06_07_2022, data_8h_21h_04_to_06_07_2022_increasing_code)  #useless now, data with the 21h-8h gap
```
...
amount_activity_30min_8h_21h_04_to_06_07_2022_compressed_time <- add_compressed_time_variable(amount_activity_8h_21h_04_to_06_07_2022)

rm(amount_activity_8h_21h_04_to_06_07_2022)  #useless now, data without compressed time variable
```
...
# 
#   # Plot
# ggplot(amount_activity_30min_8h_21h_04_to_06_07_2022_compressed_time,
...
#                      breaks = seq(from = 0, to = nrow(amount_activity_30min_8h_21h_04_to_06_07_2022_compressed_time), by = 10)) + #scale
#   ggtitle("Score de postures du renard 4313", subtitle = "Du 4 au 6 juillet 2022, toutes les 30 minutes")
```
...
```{r}
areas <- get_areas_color(data = amount_activity_30min_8h_21h_04_to_06_07_2022_compressed_time,
                          times_vector_xmin =
...
plot_activity_with_areas <- function(data, nb_min) {
