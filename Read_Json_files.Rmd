...
one_line_file \<- function(json_file, threshold = 0.5){ si le max de confidence
...
one_position_file <- function(json_file, threshold = 0.5) {
...
#Test function
one_position_file(data_json_1, threshold = 0.9)   #returns line 2
one_position_file(data_json_1, threshold = 0.999) #warning : confidence < threshold
...
datatest_1line <- one_position_file(datatest1, threshold = 0.5)
...
# Récupération de la date, format f_ID4284_02_02_2023_16_08_11.jpg

nom_fichier <- test$filename[1]  #ligne 1 nom fichier
grep("_.._.._...._", nom_fichier )
[:digit:]
strapplyc(nom_fichier, "[_](.*)[_]", simplify = TRUE)
