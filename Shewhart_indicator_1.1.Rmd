...
```{r}
load("data_QCC_indicator1.1_calibration_reliable_15min_to_6h.RData")
```
...
```{r}
# With data at the beginning of the trial
...
# With data just before death (05 to 08/08/22) : 
frequency_position_15min_8h_21h_05_07_to_08_08_2022 <- 
  frequency_position_15min_8h_21h_05_07_to_08_08_2022 %>% 
  mutate(day = as.Date(start_time))
...
```{r}
# Data of the beginning of the trial
load("data_QCC_indicator1.1_calibration_reliable_15min_to_6h.Rdata")

# Data just before death
load("data_QCC_indicator1.1_test_reliable_15min_to_6h")
...
# With data just before death (05 to 08/08/22) : 
# aggregate_by_day_1.1(frequency_position_15min_8h_21h_05_to_08_08_2022, "15min")
# 
# aggregate_by_day_1.1(frequency_position_30min_8h_21h_05_to_08_08_2022, "30min")
# 
# aggregate_by_day_1.1(frequency_position_1h_8h_21h_05_to_08_08_2022, "1h")
# 
# aggregate_by_day_1.1(frequency_position_2h_8h_21h_05_to_08_08_2022, "2h")
# 
# aggregate_by_day_1.1(frequency_position_4h_8h_21h_05_to_08_08_2022, "4h")
# 
# aggregate_by_day_1.1(frequency_position_6h_8h_21h_05_to_08_08_2022, "6h")
```
...
qcc(data = not_visible_byday_15min[1:10,], #5 first days = calibration
    type = "xbar",               #chart type
    newdata = not_visible_byday_15min[32:35,],  #5-11 days = test phase
