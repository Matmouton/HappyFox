...
#Aggregate by day with QCC function
  ...
  #15min
sitting_standing_byday_15min <- qcc.groups(data = frequency_position_15min_8h_21h_05_to_14_07_2022_StandingSitting$sitting_standing,
                                     sample = frequency_position_15min_8h_21h_05_to_14_07_2022_StandingSitting$day)

  #30min
sitting_standing_byday_30min <- qcc.groups(data = frequency_position_30min_8h_21h_05_to_14_07_2022_StandingSitting$sitting_standing,
                                     sample = frequency_position_30min_8h_21h_05_to_14_07_2022_StandingSitting$day)

  #1h
sitting_standing_byday_1h <- qcc.groups(data = frequency_position_1h_8h_21h_05_to_14_07_2022_StandingSitting$sitting_standing,
                                     sample = frequency_position_1h_8h_21h_05_to_14_07_2022_StandingSitting$day)

  #2h
sitting_standing_byday_2h <- qcc.groups(data = frequency_position_2h_8h_21h_05_to_14_07_2022_StandingSitting$sitting_standing,
                                     sample = frequency_position_2h_8h_21h_05_to_14_07_2022_StandingSitting$day)

  #4h
sitting_standing_byday_4h <- qcc.groups(data = frequency_position_4h_8h_21h_05_to_14_07_2022_StandingSitting$sitting_standing,
                                     sample = frequency_position_4h_8h_21h_05_to_14_07_2022_StandingSitting$day)

  #6h
sitting_standing_byday_6h<- qcc.groups(data = frequency_position_6h_8h_21h_05_to_14_07_2022_StandingSitting$sitting_standing,
                                     sample = frequency_position_6h_8h_21h_05_to_14_07_2022_StandingSitting$day)
...
qcc(data = sitting_standing_byday_15min[1:4,], #5 first days = calibration
    type = "xbar",               #chart type
    newdata = sitting_standing_byday_15min[5:10,])  #5-11 days = test phase


  #timesteps = 30min, 1point = 1day
qcc(data = sitting_standing_byday_30min[1:4,], #5 first days = calibration
    type = "xbar",               #chart type
    newdata = sitting_standing_byday_30min[5:10,]) #5-11 days = test phase


  #timesteps = 1h, 1point = 1day
qcc(data = sitting_standing_byday_1h[1:4,], #5 first days = calibration
    type = "xbar",               #chart type
    newdata = sitting_standing_byday_1h[5:10,]) #5-11 days = test phase

  #timesteps = 2h, 1point = 1day
qcc(data = sitting_standing_byday_2h[1:4,], #5 first days = calibration
    type = "xbar",               #chart type
    newdata = sitting_standing_byday_2h[5:10,])  #5-11 days = test phase


  #timesteps = 4h, 1point = 1day
qcc(data = sitting_standing_byday_4h[1:4,], #5 first days = calibration
    type = "xbar",               #chart type
    newdata = sitting_standing_byday_4h[5:10,]) #5-11 days = test phase
...
# qcc(data = sitting_standing_byday_6h[1:4,], #5 first days = calibration
#     type = "xbar",               #chart type
#     newdata = sitting_standing_byday_6h[5:10,]) #5-11 days = test phase
