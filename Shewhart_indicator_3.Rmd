...
Here we don't have the NA data between 14/07 & 05/08 : the table only contains dates that have data. So calibration phase = from 05/07 to 14/07 (lines 1 to 10 in the table) & test phase = from 05/08 to 08/08 (lines 11 to 14 in the table). There is 1 more column than it should be (53 instead of 52 for 15min aggregation for example), but it's only because of the 21h interval : it shouldn't change anything.
